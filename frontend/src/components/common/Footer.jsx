    ...
    return (
        ...
        >
            <Box sx={{ display: 'flex', flexDirection: 'Column', gap: '15px' }}>
                ...
                <Box sx={{ display: 'flex', gap: '1rem' }}>
                    ...
                    <FacebookOutlinedIcon
                        onClick={() =>
                            window.open(
                                'https://www.facebook.com/cycservicesbpo/',
                                '_blank'
                            )
                        }
                        sx={{ cursor: 'pointer', fontSize: 25, color: 'white' }}
                    ...
                    <LinkedInIcon
                        onClick={() =>
                            window.open(
                                'https://www.linkedin.com/company/c-c-services-sas/',
                                '_blank'
                            )
                        }
                        sx={{ cursor: 'pointer', fontSize: 25, color: 'white' }}
            ...
            >
                ...
                <Typography
                    sx={{ cursor: 'pointer' }}
                    onClick={() => navigate('/logged/vacancies')}
                    variant="subtitle2"
                    color="white"
                >
                    Vacantes
