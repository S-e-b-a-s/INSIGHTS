            ...
            >
                ...
                <Box sx={{ width: '35rem' }}>
                    <Typography sx={{ color: 'gray', textAlign: 'justify' }}>
                        Somos una compañía con más de {yearsOfExperience} años
                        de experiencia en el mercado, especializada en ofrecer
                        soluciones para fortalecer ciclos de riesgo; proveemos
                        alternativas para los procesos de originación,
                        mantenimiento y recuperación de cartera. En la
                        implementación de servicios BPO, trabajamos con
                        estándares metodológicos de calidad que nos permiten la
                        optimización de procesos para garantizar resultados que
                        maximicen la rentabilidad de la operación de nuestros
                        clientes y les facilite concentrarse en su core de
                        negocio. Nos enfocamos en prestar servicios de Contact
                        Center y BPO de alta calidad con un talento humano que
                        genere valor a nuestros clientes, basados en prácticas
                        innovadoras, experiencia, solidez en el mercado,
                        buscando un desarrollo responsable que impacte
            ...
            >
                ...
                >
                    ...
                    <Box sx={{ width: '550px' }}>
                        ...
                        >
                            Conectamos personas para transformar desafíos en
                            soluciones.
                        </Typography>
                    </Box>
                </Box>
                ...
                >
                    ...
                    <Box sx={{ width: '550px' }}>
                        ...
                        <Typography
                            ...
                            sx={{ fontSize: '16px', color: 'gray' }}
                        >
                            En C&C, los valores corporativos constituyen la
                            columna vertebral de nuestra cultura y orientan cada
                            faceta de la operación. Son el motor que nos impulsa
                            hacia adelante, permitiéndonos cumplir con las
                            expectativas de clientes, empleados y comunidades,
                            al tiempo que construimos un futuro sostenible y
                            exitoso:
                            <li>Pasión</li>
                            <li>Integridad</li>
                            <li>Innovación</li>
                ...
                >
                    <Box sx={{ width: '550px' }}>
                        ...
                        <Typography
                            ...
                            sx={{ fontSize: '16px', color: 'gray' }}
                        >
                            Nuestro compromiso esta basado en garantizar la
                            excelencia en servicios de Contact Center,
                            recuperación de cartera, gestión jurídica, estudios
                            de riesgo e investigación, para ello, contamos con
                            personal capacitado y en formación permanente, que
                            nos permite tener procesos basados en una cultura de
                            calidad y de mejora continua, que busca fortalecer
                            el sostenimiento financiero de la organización.
                        </Typography>
                    </Box>
                    <img
                        style={{ borderRadius: '8px' }}
                ...
                >
                    ...
                    <Box sx={{ width: '550px' }}>
                        ...
                        >
                            <li>
                                Buscar la satisfacción de nuestros clientes para
                                asegurar la generación de nuevos negocios.{' '}
                            </li>
                            <li>
                                Cumplir con los tiempos y especificaciones
                                acordadas con nuestros clientes.{' '}
                            </li>
                            <li>
                                Capacitar al personal para asegurar el desempeño
                                de sus competencias.{' '}
                            </li>
                            <li>
                                Evaluar continuamente los procesos buscando su
                                mejora continua.{' '}
                            </li>
                            <li>
                                Asegurar la rentabilidad y sostenibilidad de la
                                organización.
                            </li>
                        </Typography>
                    </Box>
            ...
            >
                ...
                >
                    <Container fixed maxWidth="md">
                        ...
                        >
                            Soy el fundador de C&C, desde muy joven soñaba con
                            crear una empresa que pudiera impulsar el
                            crecimiento económico de nuestro país y al mismo
                            tiempo crear empleos de calidad para la gente que
                            compartiera esta visión. Mis amigos más cercanos me
                            definen como una persona emprendedora y visionaria.
                            La idea inicial de nuestra compañía surgió cuando yo
                            trabajaba en el área legal de un reconocido banco
                            colombiano, en el cual, me desempeñé en la gestión y
                            administración de cartera jurídica, en ese rol
                            jurídico, identifiqué rápidamente algunas
                            necesidades insatisfechas que en ese entonces tenían
                            los deudores en asuntos como conciliaciones,
                            acuerdos de pago, condonaciones, reestructuración de
                            créditos, entre otros, lo cual, les dificultaba
                            sanear sus obligaciones y acceder a nuevas
                            oportunidades de rebancarización.
                            <br />
                            <br />
                            Fue así como en septiembre de 2004, decidí iniciar
                            este proyecto para ofrecer servicios de consultoría
                            al sector financiero en gestión de cobro y
                            administración de cartera jurídica, poniendo a
                            disposición del mercado mis años de experiencia y
                            mis valores personales como la guía inicial para
                            consolidar una idea que poco a poco se transformaba
                            en realidad.
                            <br />
                            <br />
                            Nuestro primer cliente fue el banco Davivienda, con
                            ellos tuvimos la gran oportunidad de empezar
                            nuestras operaciones en Bogotá, a raíz de las
                            necesidades del mercado nuestra compañía fue
                            evolucionando en la prestación de servicios BPO y en
                            el año 2005 consolidamos tres líneas de negocio,
                            legal, riesgo y servicios de Call Center y Contact
                            Center; a partir de las cuales, hemos logrado un
                            crecimiento sostenible basado en valores como
                            pasión, integridad, innovación, impacto social y
                            excelencia.
                            <br />
                            <br />
                            Aunque empezamos con una línea muy marcada en
                            gestión de cartera, hoy en día somos fuertes en
                            televentas y servicio al cliente, contamos con
                            alrededor de 900 empleados, cuatro sedes a nivel
                            nacional, prestamos servicios a cinco países de
                            Latinoamérica y en nuestro portafolio actual se
                            cuentan más de 30 clientes B2B en sectores como
                            bancario, salud, real, cooperativo, comunicaciones,
                            seguros y Fintech.
                            <br />
                            <br />
                            Nuestra visión para el futuro está enfocada en la
                            vanguardia tecnológica, la innovación, la expansión
                            y el desarrollo integral de herramientas que
                            potencien los resultados de nuestros clientes.
                        </Typography>
                    </Container>
                </Box>{' '}
